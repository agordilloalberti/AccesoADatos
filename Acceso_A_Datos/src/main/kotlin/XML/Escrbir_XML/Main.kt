...
fun main() {
    ...
    val ficheroXML = Path.of("C:\\Users\\UsuarioT\\IdeaProjects\\AccesoADatos\\Acceso_A_Datos\\src\\main\\resources\\XML.xml\\Escribir\\Escritura.xml")
...
fun crearXML(nodos: Int, nombresA: ArrayList<String>, preciosA: ArrayList<String>){
    ...
    val r = StreamResult(Path.of("C:\\Users\\UsuarioT\\IdeaProjects\\AccesoADatos\\Acceso_A_Datos\\src\\main\\resources\\XML.xml\\Escribir\\Escritura.xml").toFile())
